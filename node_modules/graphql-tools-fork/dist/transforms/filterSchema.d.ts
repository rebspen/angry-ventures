...
export declare type RootFieldFilter = (operation: 'Query' | 'Mutation' | 'Subscription', rootFieldName: string) => boolean;
export declare type FieldFilter = (typeName: string, rootFieldName: string) => boolean;
